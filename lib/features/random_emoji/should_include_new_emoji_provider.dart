...
final shouldIncludeNewEmojiProvider =
    AsyncNotifierProvider<ShouldIncludeNewEmojiController, bool>(() {
  return ShouldIncludeNewEmojiController();
});

class ShouldIncludeNewEmojiController extends AsyncNotifier<bool> {
  ShouldIncludeNewEmojiController();

  Future<void> init() async {
    _addListeners();
  }

  static const _tag = 'should_include_new_emoji_provider';
  ...
  static const _storageKey =
      'should_include_new_emoji_${AppConstants.configEnvironment}';
